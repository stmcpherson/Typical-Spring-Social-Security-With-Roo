...
import pangeanembassy.security.domain.UserDataOnDemand;
...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserIntegrationTest.testCountUsers() {
        ...
        long count = pangeanembassy.security.domain.User.countUsers();
    ...
    public void UserIntegrationTest.testFindUser() {
        pangeanembassy.security.domain.User obj = dod.getRandomUser();
        ...
        obj = pangeanembassy.security.domain.User.findUser(id);
    ...
    public void UserIntegrationTest.testFindAllUsers() {
        ...
        java.util.List<pangeanembassy.security.domain.User> result = pangeanembassy.security.domain.User.findAllUsers();
    ...
    public void UserIntegrationTest.testFindUserEntries() {
        ...
        java.util.List<pangeanembassy.security.domain.User> result = pangeanembassy.security.domain.User.findUserEntries(0, (int) count);
    ...
    public void UserIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUser(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        pangeanembassy.security.domain.User merged =  obj.merge();
        obj.flush();
    ...
    public void UserIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'User' failed to initialize correctly", dod.getRandomUser());
        pangeanembassy.security.domain.User obj = dod.getNewTransientUser(Integer.MAX_VALUE);
    ...
    public void UserIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'User' with identifier '" + id + "'", pangeanembassy.security.domain.User.findUser(id));
    }
